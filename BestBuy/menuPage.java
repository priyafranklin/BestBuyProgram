...
public class menuPage extends BaseClass {
	...
	public static void TotaltechMembership() throws InterruptedException {
		Thread.sleep(2000);
		WebElement menuSelectElement2 = wait.until(driver -> {
			return driver.findElement(By.xpath("//a[@data-lid=\"hdr_best_buy_totaltech\"]"));
		});
		menuSelectElement2.click();
	}
	...
	public static void GiftIdeas() throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement menuSelectElement5 = wait.until(driver -> {
			return driver.findElement(By.xpath("//a[@data-lid=\"hdr_gift_ideas\"]"));
		});
		menuSelectElement5.click();
	}

	public static void HealthWellness() throws InterruptedException {

		Thread.sleep(2000);
		WebElement menuSelectElement6 = wait.until(driver -> {
			return driver.findElement(By.xpath("//a[@data-lid=\"hdr_health\"]"));
		});
		menuSelectElement6.click();
	}

	public static void BestBuyOutlet() throws InterruptedException {

		Thread.sleep(2000);
		WebElement menuSelectElement7 = wait.until(driver -> {
			return driver.findElement(By.xpath("//a[@data-lid=\"hdr_best_buy_outlet\"]"));
		});
		menuSelectElement7.click();
	}
